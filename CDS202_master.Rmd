...
#Load library
library(tidyverse)
pacman::p_load(tidyverse, brms, dplyr, Hmisc, ggpubr, ggplot2, ggthemes, plyr, knitr)
getwd()
...
source(here::here('functions', 'Bayes_analysis.R'))
...
```{r}
SAD_m <- bayes_analysis(scores)
summary(SAD_m)
hypothesis(SAD_m, "CUSADOS_scaled >0")
hypothesis(SAD_m, "CUSADOS_scaled >0.7")
```
